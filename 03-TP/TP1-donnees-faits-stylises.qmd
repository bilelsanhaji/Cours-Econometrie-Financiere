...
`03-TP/corriges/TP1-donnees-faits-stylises-R-corrige.qmd`.

**Package clé.** `quantmod`, pour l'import des données (`getSymbols`,
...
::: {.notes}
Cet exercice prépare directement l'étape préliminaire du projet — décrire
les données avant de spécifier un modèle GARCH (TP3).
:::
