...
`03-TP/corriges/TP4-mgarch-R-corrige.qmd`.

**Packages clés.** `rmgarch` (`dccspec`, `dccfit`, `dccforecast`),
`rugarch` (spécifications univariées en entrée du DCC).
...
::: {.notes}
Cet exercice conclut la partie "modélisation" du projet : moyenne
(ARMA, chapitre 2) $\to$ variance univariée (GARCH, chapitre 3)
$\to$ covariance/corrélation multivariée (DCC, ce chapitre) sur le
portefeuille retenu, jusqu'au backtesting de la VaR qui boucle le cours.
:::
